...
#SBATCH --exclude=dcc-tdunn-gpu-01,dcc-tdunn-gpu-02,dcc-lefkowitz-gpu-05,dcc-mastatlab-gpu-01,dcc-gehmlab-gpu-04,dcc-dhvi-gpu-01,dcc-dhvi-gpu-02,dcc-allenlab-gpu-03,dcc-allenlab-gpu-04,dcc-youlab-gpu-01
set -e
...
dannce-predict-multi-gpu --only-unfinished=True --n-samples-per-gpu=2500 $1
dannce-merge $1
